...
// thông tin wifi
const char* ssid = "Cool cool cool";
const char* password = "alohahaha";
...
/*chức năng thông báo cho tất cả các máy khách với các giá trị thanh trượt hiện tại. 
Gọi hàm này là chức năng cho phép chúng tôi thông báo các thay đổi trong tất cả các máy khách
bất cứ khi nào bạn đặt vị trí mới cho thanh trượt.*/
...
void setup() {
  ...
  // URL gốc máy chủ web
    ...
    server.on("/light1", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send(SPIFFS, "/light1.jpg", "image/jpg");
    });
